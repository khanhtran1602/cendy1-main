...
export function ComboboxContent({
  ...
  // Calculate the adjusted left position to keep dropdown within screen
  const dropdownWidth = Math.max(triggerLayout.width, 150); // Minimum width of 150
  const rightEdge = triggerLayout.x + dropdownWidth;
  const adjustedLeft = rightEdge > screenWidth
    ? Math.max(16, screenWidth - dropdownWidth - 16) // Keep 16px padding from edges
    : triggerLayout.x;
